...
const Chat = () => {
    ...
    const handleSendMessage = () => {
        ...
        const messageData = {
            ...
            sender: user._id,
            timestamp: Date.now(),
            id: `${user._id}-${Date.now()}-${Math.random().toString(36).substring(2, 10)}`
        };
        ...
        <SafeAreaView style={styles.chatContainer}>
            <View style={{ flex: 1, position: 'relative' }}>
                ...
                <FlatList
                    ...
                    contentContainerStyle={{ paddingBottom: 120 }}  // Espacio adicional para la barra de entrada
                    renderItem={({ item }) => (
                        <View style={[
                            styles.chatMessageBubble,
                            item.sender === user._id ? styles.chatSentBubble : styles.chatReceivedBubble
                        ]}>
